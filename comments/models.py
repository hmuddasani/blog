...
class CommentManager(models.Manager):
	...
	def create_comment(self, user=None, path=None, BlogEntry=None, text=None, parent=None):
...
class Comment(models.Model):
	...
	BlogEntry = models.ForeignKey(BlogEntry, null=True, blank=True)
